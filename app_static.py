...
CPL_BY_MONTH = {"январь": 1466, "февраль": 1918, "март": 1951, "апрель": 2155}
...
LEADS_BY_CHANNEL_MONTH = {
    "Instagram":     {"январь": 152, "февраль": 200, "март":  98, "апрель": 160},
    "Яндекс.Директ": {"январь":  35, "февраль":  52, "март":  38, "апрель":  33},
    "Авито":         {"январь":  30, "февраль":  40, "март":  30, "апрель":  23},
    "VK Таргет":     {"январь":  30, "февраль":  42, "март":  30, "апрель":  21},
    "Циан":          {"январь":  30, "февраль":  42, "март":  30, "апрель":  21},
    "Telegram":      {"январь":   3, "февраль": 144, "март":  14, "апрель":  92},
}
